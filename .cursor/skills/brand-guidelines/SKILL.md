...
Defined in `src/index.css` `@theme` block. Stocks uses an oklch-based palette with a vibrant purple-blue primary.
...
| `--color-primary` | `bg-primary` | Primary action (purple-blue) |
...
| `--color-chart-line` | `stroke-chart-line` | Chart line color |
| `--color-chart-fill` | `fill-chart-fill` | Chart fill (10% opacity) |
...
- Stocks' primary is a vibrant purple-blue (`oklch(0.49 0.24 264)`).
