...
Reference relevant task items from `tasks/` with task ID and title.

- [ ] `tasks/NNN-slug.md` - <title>
- [ ] N/A
...
- **Cloud Run (stocks-api):** <impact or N/A>
- **Secrets:** <new requirements, rotations, or N/A>
